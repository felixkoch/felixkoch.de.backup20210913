...
export default () => (
  <Page title="Datenschutz">
    <div className="container">
      <h1 className='mb-5'>Datenschutzerklärung</h1>
      ...
      <p>
        <span id="s3-t-firma">Felix Fabian Koch</span>
        <br />
        <span id="s3-t-ansprechpartner">Ansprechpartner</span>
        <br />
        <span id="s3-t-strasse">In der Reith 12</span>
        <br />
        <span id="s3-t-plz">27386</span> <span id="s3-t-ort">Bothel</span>
      </p>
      <p />
      <p>
      ...
      <p>
        Einzelheiten zur Datennutzung durch Amazon finden Sie in der Amazon
